...
/**
 * Used to validate that a value meets a minimum threshold
 * @param min The minimum allowed value (number for numeric/string length/array length, Date for dates)
 * @param message Optional custom error messages
 * @returns A min modifier that validates values are at or above the minimum
 */
